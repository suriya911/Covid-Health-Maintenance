...
declare module 'http2' {
    ...
    export interface ServerHttp2Session extends Http2Session {
         ...
         * });
         * server.on('session', (session) => {
         *   session.origin('https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io', 'https://example.org');
         * });
         * ```
         *
         ...
         * const http2 = require('http2');
         * const options = getSecureOptionsSomehow();
         * options.origins = ['https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io', 'https://example.org'];
         * const server = http2.createSecureServer(options);
         * server.on('stream', (stream) => {
         *   stream.respond();
         *   stream.end('ok');
