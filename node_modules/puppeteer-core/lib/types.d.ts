 ...
 *   await page.goto('https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io');
 *   await browser.close();
 * })();
 * ```
 *
...
export declare class BrowserContext extends EventEmitter {
     ...
     * ```
     *
     * @param origin - The origin to grant permissions to, e.g. "https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io".
     ...
     * ```ts
     * const context = browser.defaultBrowserContext();
     * context.overridePermissions('https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io', ['clipboard-read']);
     * // do stuff ..
...
export declare class ElementHandle<ElementType extends Node = Element> extends JSHandle<ElementType> {
     ...
     *
     *   for (currentURL of [
     *     'https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io',
     *     'https://google.com',
     *     'https://bbc.com',
     *   ]) {
...
export declare class HTTPRequest {
     ...
     * `https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io`, then the chain will contain one request:
     *
     * ```ts
...
export declare class HTTPResponse {
    ...
    */
    ...
    export declare class Page extends EventEmitter {
         ...
         *   'https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io/resource'
         * );
         * const finalRequest = await page.waitForRequest(
         *   request => request.url() === 'https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io'
         * );
         ...
         *   response =>
         *     response.url() === 'https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io' && response.status() === 200
         * );
    ...
    export declare const enum PageEmittedEvents {
         ...
         * const [popup] = await Promise.all([
         *   new Promise(resolve => page.once('popup', resolve)),
         *   page.evaluate(() => window.open('https://8080-ddbeaaecdfcdeaaefedffcfecbdeeecbaafbda.project.examly.io')),
         * ]);
         * ```
         */
        Popup = "popup",
    ...
    /* Excluded from this release type: rm */

    /* Excluded from this release type: rmSync */
